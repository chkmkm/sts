...
public class UpdateController {
	...
	@RequestMapping(value="guest/{idx}/form", method=RequestMethod.GET)
	public String editform(@PathVariable("idx")int sabun, Model model){
	...
	public String guestUpdate(@PathVariable("idx")int sabun, GuestVo bean){
